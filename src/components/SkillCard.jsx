...
const SkillCard = ({skill, percentage, color,  move}) => {
  return <div className={`border border-[rgba(255,255,255,0.3)] rounded-md
  px-8 py-3 cursor-pointer group w-full flex items-center justify-between relative gap-2`}
  style={{
    boxShadow: "inset 0px 0px 10px rgba(255,255,255,0.3)",
    marginLeft: move ? -30 : 20,
  }}
  >
    <div className="flex-1 flex-col items-start justify-start flex gap-1 ">
